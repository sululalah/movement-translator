...
(function(){
  ...
  if(abM1ClearBtn){abM1ClearBtn.addEventListener('click',()=>{mCtx.fillStyle='#fff8f0';mCtx.fillRect(0,0,abCanvas.width,abCanvas.height);abResetTrails();});}
  ...
  if(abM2ClearBtn){abM2ClearBtn.addEventListener('click',()=>{mCtx.fillStyle='#fff8f0';mCtx.fillRect(0,0,abCanvas.width,abCanvas.height);abResetTrails();gCtx.clearRect(0,0,abGhost.width,abGhost.height);});}
  abResize();
